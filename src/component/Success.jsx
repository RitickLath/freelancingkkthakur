...
const Success = () => {
  return (
    <div className="md:flex justify-between py-16 text-white my-16 px-6 md:px-20 lg:px-32">
      {/* Header Section */}
      <div className="mb-12">
        <h1 className="pt-6 text-3xl md:text-5xl font-bold">
      ...
      <div className="md:w-[440px]">
        ...
        <div className="py-6 border-b-[1px]">
          ...
          <h2 className="text-lg mt-2">Fast project deployment for growth.</h2>
        </div>

        {/* End-to-End Service Commitment */}
        <div className="py-6 border-b-[1px]">
          <h1 className="text-3xl md:text-5xl font-semibold">End-to-End</h1>
          <h2 className="text-lg mt-2">Full service from start to finish.</h2>
        </div>
      </div>
    </div>
  );
